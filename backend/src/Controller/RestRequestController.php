...
final class RestRequestController extends AbstractController
{
    ...
    public function create(
        ...
        return $entityManager->wrapInTransaction(function () use ($accessToken, $request, $playerAccess, $restRequestRepository, $entityManager, $characterState): JsonResponse {
            PlayerCharacterAccess::lockForMutation($entityManager, $characterState);
    ...
    public function resolve(
        ...
        return $entityManager->wrapInTransaction(function () use ($requestId, $request, $restRequestRepository, $characterRestService, $entityManager): JsonResponse {
            $restRequest =
            ...
            PlayerCharacterAccess::lockForMutation($entityManager, $restRequest->getCharacterSessionState());
            $entityManager->refresh($restRequest, \Doctrine\DBAL\LockMode::PESSIMISTIC_WRITE);
